...
const About = () => {
    ...
    // Firebase URLs are absolute, use directly. Use fallback if empty.
    ...
    return (
        <section className="about section" id="about">
            ...
            <div className="about__container container grid">
                <img src={imageUrl} alt="About" className="about__img" />

                <div className="about__data">
                    <Info info={aboutData.info} />

                    <p className="about__description">
                        {aboutData.description || "Loading..."}
                    </p>

                    <a download="" href={cvUrl} className="button button--flex" target="_blank" rel="noreferrer">
                        Download CV
